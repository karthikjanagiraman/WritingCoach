...
- If right: "Exactly! You've got it. Ready to practice together?"

TRANSITION TO GUIDED PRACTICE:
When student demonstrates understanding, use transition like:
"Great! You've got it. Now let's try this together. I'll help you along the way."
...
After successful practice (usually 2-3 exchanges):
